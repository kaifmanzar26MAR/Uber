...
const VehiclePanel = ({ vehiclePanelCloseRef, setIsVehiclePanelOpen, setIsRidePanelOpen }) => {
    const handleRideSelect = () =>{
        setIsVehiclePanelOpen(false);
        setIsRidePanelOpen(true);
    }
  return (
    <>
      ...
      {/* //*Car */}
      <div onClick={handleRideSelect} className="flex items-center justify-between mb-2 w-full p-2 border-2 active:border-black border-gray-300 rounded-xl cursor-pointer">
        <img
